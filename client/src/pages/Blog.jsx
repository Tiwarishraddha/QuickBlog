        ...
        <div className='mt-14 mb-10 max-w-3xl mx-auto'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            {comments.map((item, index) => (
              <div key={index} 
              className='relative bg-primary/2 border border-primary/5 max-w-xl p-4 rounded-2xl
              text-gray-600'>
      ...
      {/*Add comment section */}
        <div className='max-w-3xl mx-auto'>
            <p className='font-semibold mb-4'>
              ...
              <button className='bg-primary text-white rounded p-2 px-8 hover:scale-102
