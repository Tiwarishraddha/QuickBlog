  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        ...
        <div className='text-center mt-20 mb-8'>
            ...
            mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text
            -primary'>
                <p>
            ...
            text-gray-500'>This is your space to think out loud, to share shat matters, 
            and to write without filters, Whether it's one word or a thousand, 
            your story starts right here.</p>

            <form className='flex justify-between max-w-lag max-sm:scale-75 mx-auto
